...
- - [Background](#background)
  - - [Setup](#setup)
    - - [Phase 1 — XSS Attack via LLM Output](#phase-1--xss-attack-via-llm-output)
      - - [Phase 2 — SQL Injection via LLM Output](#phase-2--sql-injection-via-llm-output)
        - - [Phase 3 — Command Injection via LLM Output](#phase-3--command-injection-via-llm-output)
          - - [Comparison: Unsafe vs Safe](#comparison-unsafe-vs-safe)
            - - [Security Observations](#security-observations)
              - - [Key Takeaways](#key-takeaways)
                - - [OWASP LLM02: Insecure Output Handling](#owasp-llm02-insecure-output-handling)
