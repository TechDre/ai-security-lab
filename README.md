...
A hands-on AI security engineering learning lab covering prompt injection detection, LLM guardrails, network traffic analysis, supply chain security, excessive agency, vector/embedding attacks, data extraction, and insecure output handling — mapped to the OWASP Top 10 for LLM Applications.
              ...
              - - Labs 1-2: `pip install transformers torch sentencepiece protobuf`
                - - Lab 3: `sudo apt install -y wireshark`
                  - - Lab 4: `pip install pip-audit`
                    - - Labs 5-8: No external dependencies (Python stdlib only)
